    ...
    <footer className="py-8 mt-10 w-4/5 mx-auto flex flex-col md:flex-row items-center justify-between text-center md:text-left border-t border-gray-700">
      ...
      <div className="flex flex-col items-center md:items-end">
        <button
          ...
          className="mt-4 md:mt-0 bg-purple-600 hover:bg-purple-700 text-white px-5 py-2 rounded-lg shadow-md transition duration-300"
        >
          Share Feedback
        </button>
          ...
          <div className="bg-white p-6 rounded-lg shadow-xl w-96">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
              <input
                ...
                className="p-3 border rounded-md outline-none focus:ring-2 focus:ring-purple-500 placeholder-gray-600 text-gray-900"
                required
              />
              <input
                type="tel"
              ...
              <button
                type="submit"
                className="bg-purple-600 hover:bg-purple-700 text-white py-2 rounded-lg shadow-md transition duration-300"
              >
                Submit
              </button>
              <button
